...
class CInWeatherData : public CObservable<SWeatherInfo>
{
public:
...
protected:
	...
	SensorTypes m_sensorType = SensorTypes::In;
	double m_temperature = 0.0;
	double m_humidity = 0.0;
	double m_pressure = 760.0;
};

class COutWeatherData : public CInWeatherData
{
public:
	COutWeatherData()
	{
		m_sensorType = SensorTypes::Out;
	}
